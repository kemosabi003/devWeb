...
document.addEventListener('keypress', (event) => {
  ...
  if(keyCode === 13) {
    ...
    console.log((document.getElementById('userInput').value).toLowerCase());
    wordArray.forEach(letter => { 
      if(document.getElementById('userInput').value.toLowerCase() === letter) {
        correctLetters.push(letter);
        
        return;
      }
    });
    wrongLetters.push(document.getElementById('userInput').value.toLowerCase());
    render();
  }
})
